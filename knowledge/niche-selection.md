...
spas would be the right one what are some other niches that you know wouldnt be heavily cold called
and targeted by other agencies so they are likely to want to run ads and will also be worth my
time."*

**He is right about med spas.** They are one of the most agency-farmed categories that exists. The
owner has been pitched weekly for years, and the Google auction is expensive, so even a won deal is
hard to deliver on.

## The farmed list, to avoid or at least deprioritise

Med spa · personal injury law · roofing · HVAC · dental implants · chiropractic · solar · real
estate agents · plumbing · gyms. Also **addiction treatment**, which looks tempting on ticket size
but needs Google LegitScript certification and is farmed hardest of all.

## The test, which matters more than any list

A niche is worth his time when all four are true:

1. **One job is worth $3,000+, or a contract is worth $1,500+ a month.** Below that the arithmetic
   for a $400-1,000/mo fee never feels obvious to the buyer.
2. **People search for it at the moment they need it.** Google Ads rewards intent. A category people
   discover rather than search for belongs on Meta, which is still gated (KB `meta-marketing-api`).
3. **The owner answers the phone.** Under roughly 20 employees, owner-operated, not a franchise.
4. **Ads would be a NEW channel for them, not their fifth agency.**

🔴 **Warning sign:** if the Google results for that niche are wall-to-wall franchise ads, the auction
is expensive and a won client is a client he will struggle to deliver for.

## The recommendations, in order

| Niche | Why it works |
|---|---|
| **Commercial cleaning / janitorial** | The unfarmed twin of house cleaning. Contracts recur at $2-8k/month, so ONE win pays his fee for a year and that story sells itself. Agencies chase homeowners and skip this entirely |
| **Artificial turf installation** | Phoenix-specific gold. $10-20k jobs, enormous local demand, and most of these companies market badly |
| **Pool remodelling / resurfacing** | Phoenix has pools everywhere and a resurface is $10-25k. Note: REMODEL, not pool cleaning, which is too low-ticket |
| **Audiology / hearing aids** | $3-7k per fitting, patients search on Google, practices are owner-run and unsophisticated, and no agency bothers |
| **Epoxy / garage floor coating** | $3-8k jobs, growing category, weak marketing, and the before-and-after photos make the creative easy |
| **ABA therapy / autism services** | High lifetime value, insurance pays, demand far exceeds supply, essentially zero agency competition. Longer sales cycle, so not the first-week pick |
| **Foundation repair** | Roofing economics without roofing saturation. Urgent, $5-40k |
| **Commercial landscaping** | HOA and property-manager contracts, recurring, and again the commercial twin nobody calls |

## 🔴 The advice that actually matters

**Pick ONE and stay on it for 100 calls.** Five niches is five scripts, five sets of objections he
has never heard before, and no compounding. One niche means by call 40 he knows what they say and
what beats it, and the research and the report template get reused.

**Lead Scout's "Currently advertising" filter is the saturation check**: if almost nobody in a niche
