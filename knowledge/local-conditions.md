...
- **A conditions-CHANGE trigger for rewrites.** The fingerprint is recorded and ready, but the
  challenger is still gated on impressions and a 168h cooldown. Triggering purely on a weather change
  risks churning live ads every time an advisory posts and expires. The safe version needs a
  minimum-dwell rule before it ships.
