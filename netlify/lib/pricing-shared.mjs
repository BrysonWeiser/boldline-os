...
// founding clients, and they pay for RESULTS ONLY with no monthly minimum at
...
// 🔴 AND IMPORTED, NOT JUST RE-EXPORTED, because the prompt below quotes the figure out loud.
// It used to say "first 3 clients" in two hardcoded places, which is the drift this whole file
// exists to prevent: the day the number changes, a model would have gone on telling prospects
// the old one while the code enforced the new one.
import { FOUNDING_CLIENT_COUNT } from "./founding.mjs";
